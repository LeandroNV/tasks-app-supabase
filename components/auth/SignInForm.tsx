            ...
            <div className="w-full backdrop-blur-xl py-2 rounded-4xl">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="mx-4">
                    <div className="grid gap-2">
                        ...
                        />
                            ...
                            <div className="mb-6 text-end text-sm text-white">
                                <button
                                    type="button"
                                    onClick={() =>
                ...
                <p className="text-center text-sm text-white mt-4">
                    ...
                    <button
                        ...
                        className="inline bg-transparent border-0 p-0 font-inherit text-inherit underline underline-offset-4 hover:text-primary cursor-pointer"
                    >
                        Regístrate
                    </button>
                </p>
